...
class FrontendArchitectureContractTest extends TestCase
{
    public function test_required_enterprise_frontend_structure_exists(): void
    {
        $required = [
            ...
            'src/components/cards/DashboardCards.tsx',
            ...
            'src/components/tabs/SettingsTabs.tsx',
            'src/components/landing/LandingPageHero.tsx',
            ...
            'src/components/wrappers/LoaderWrapper.tsx',
            'src/components/layout/Sidebar.tsx',
            'src/components/layout/Topbar.tsx',
            'src/components/history/ChatHistoryList.tsx',
            'src/components/profiles/ProfilePageCard.tsx',
            'src/components/analytics/AnalyticsTable.tsx',
            'src/components/vectordb/VectorDBCard.tsx',
            'src/components/llm/LLMCard.tsx',
